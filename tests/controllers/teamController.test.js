  ...
  describe('addMember', () => {
    it('should add a member to the project', async () => {
      jest.spyOn(services, 'addMember').mockResolvedValue([
        { project_id: 'abc', key_status: true, username: 'Balkar', role: 'frontend', start_date: '2020-01-01', end_date: '2020-01-01', cost: 2000 },
      ]);
      const req = {
      ...
      expect(res.json).toHaveBeenCalledWith([
        { project_id: 'abc', username: 'Balkar', key_status: true, role: 'frontend', start_date: '2020-01-01', end_date: '2020-01-01', cost: 2000 },
      ]);
    });
